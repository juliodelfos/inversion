<template>
  <!--
    ...
    ```
  -->
  <main class="grid min-h-full place-items-center  px-6 py-24 sm:py-32 lg:px-8 border-red-300 border-2">
    <div class="text-center">
      ...
      <p class="mt-6 text-base leading-7 text-gray-600">La página que buscabas no existe o tiene algún error.</p>
