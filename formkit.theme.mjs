/**
  ...
  *
  * @checksum - 950b9534e0c701dd16fbcda4500d7e9746d640b13d20f6ea9805368573254570
  * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=neutral,spacing=2.5,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
